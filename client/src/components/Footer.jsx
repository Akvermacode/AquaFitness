        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <ul className='space-y-2'>
              ...
              <li>
                <a href="https://www.instagram.com/accounts/login/?next=%2F&source=mobile_nav" className='text-lg text-gray-300 hover:text-indigo-500 transition-all'>Instagram</a>
              </li>
              <li>
                <a href="#" className='text-lg text-gray-300 hover:text-indigo-500 transition-all'>LinkedIn</a>
              </li>
